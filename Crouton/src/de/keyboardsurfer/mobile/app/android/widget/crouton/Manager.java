...
final class Manager extends Handler {
	...
	private void handleTranslucentActionBar(
		...
		if (Build.VERSION.SDK_INT >= 19) {
			...
			final int translucentStatusFlag = 67108864;// WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS;
	...
	private void handleActionBarOverlay(ViewGroup.MarginLayoutParams params,
		...
		if (Build.VERSION.SDK_INT >= 11) {
			// final boolean flags = activity.getWindow().hasFeature(9);
	...
	public static void announceForAccessibilityCompat(Context context,
		...
		if (Build.VERSION.SDK_INT >= 4) {
			...
			if (Build.VERSION.SDK_INT < 16) {
				...
				eventType = 16384;// AccessibilityEvent.TYPE_ANNOUNCEMENT;
			}
